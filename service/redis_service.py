...
if socket_ip in ['127.0.0.1', '192.168.1.51', '192.168.1.111']:
...
# 整个flask 进程logging 都没了
# logging.info('REDIS_URL: %s', REDIS_URL)


def init_setting():
	if socket_ip in ['127.0.0.1', '192.168.1.51', '192.168.1.111']:
		os.environ.setdefault("DYNACONF_SETTINGS", "settings.dev")
		print(os.environ.get('DYNACONF_SETTINGS'), REDIS_URL)
	else:
		os.environ.setdefault("DYNACONF_SETTINGS", "settings.pro")
		password = 'zhiyiredis'
		print(os.environ.get('DYNACONF_SETTINGS'), REDIS_URL)
